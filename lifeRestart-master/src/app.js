    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                ...
                <div style="font-size:1rem; font-weight:normal;">原版跳转<a href="https://liferestart.syaro.io/view/index.html" style="color: aqua;">->o</a></div>
                <div style="font-size:1rem; font-weight:normal;">原版github跳转<a href="https://github.com/VickScarlet/lifeRestart" style="color: aqua;">->o</a></div>
            </div>
        ...
        <div id="main">
            ...
            <div>
                <button id="randomz1" class="mainbtn">随便选</button>
                <button id="randomz1all" class="mainbtn">我全都要!</button>
            </div>
        </div>
        `);
        ...
        talentPage.find('#randomz1all').click(()=>{Array.from(document.querySelector('#talents').children).forEach(i=>{i.click()})});
        talentPage
            .find('#random')
            .click(()=>{
                    ...
                    .forEach(talent=>{
                        ...
                        li.click(()=>{
                            if(li.hasClass('selected')) {
                                ...
                                this.#talentSelected.delete(talent);
                                // if(this.#talentSelected.size<3) {
                                //     talentPage.find('#next').text('请选择3个以上')
                                // }
                            } else {
                                // if(this.#talentSelected.size==3) {
                                //     this.hint('只能选3个以上天赋');
        ...
        <div id="main">
            <div class="head" style="font-size: 1.6rem">
                ...
                <div style="font-size:1rem; font-weight:normal;">调整属性点：<input id="total1" value="0" style="background: inherit; font: inherit; color: inherit; border: none; width: 4em;"></div>
            </div>
            <ul id="propertyAllocation" class="propinitial" style="justify-content: end;"></ul>
            <ul class="selectlist" id="talentSelectedView" style="flex:0.6;"></ul>
            <div class="btn-area">
        ...
        propertyPage.mounted = ()=>{
            ...
            propertyPage.find('#total1').val(this.#totalMax);
            propertyPage.find('#total1').on('input',()=>this.#totalMax=Number(propertyPage.find('#total1').val()));
        }
        const groups = {};
        const total = ()=>{
            let t = 0;
        ...
        groups.CHR = getBtnGroups("颜值", -Infinity, Infinity); // 颜值 charm CHR
        groups.INT = getBtnGroups("智力", -Infinity, Infinity); // 智力 intelligence INT
        groups.STR = getBtnGroups("体质", -Infinity, Infinity); // 体质 strength STR
        groups.MNY = getBtnGroups("家境", -Infinity, Infinity); // 家境 money MNY
        ...
        propertyPage
            ...
            .click(()=>{
                ...
                let t = parseInt(propertyPage.find('#total1').val()), arr = [0,0,0,0], t1 = 0;
                // for (let i = 0; i < arr.length; i++) {
                //     arr[i] = Math.floor(Math.random()*t);
                // }
                // while (t1!=t) {
                //     // t1 = arr[0]+arr[1]+arr[2]+arr[3];
                //     // if (t1 > t) {
                //     //     arr[Math.floor(Math.random()*4)] -= (t1 - t);
                //     // } else {
                //     //     arr[Math.floor(Math.random()*4)] -= (t - t1);
                //     // }
                // }

                for (let i = 0; i < arr.length-1; i++) {
                    t1 += (arr[i] = Math.floor(Math.random()*(t-t1)));
                }
                arr[3] = t-t1;
            ...
            <div style="display: flex;">
                ...
                <div>
                    <div>
                        ...
                        <input id="evtgetinfo" value="[[10001,10]]" readOnly="true" style="background: inherit; font: inherit; color: white; border: none; width: 4em;">
                    </div>
                    <div>
                        <a href="https://github.com/VickScarlet/lifeRestart/blob/master/data/events.json" style="color: white;">setid:</a>
                        <input id="evtsetid" value="10001" type="number" style="background: inherit; font: inherit; color: white; border: none; width: 4em;">
                    </div>
                </div>
            </div>
        ...
        trajectoryPage
            ...
            .click(()=>{
                if(this.#isEnd) return;
                const trajectory = this.#life.next1('set',Number(trajectoryPage.find('#evtsetid')[0].value));
        ...
        <div id="main">
            ...
            <ul id="talents" class="selectlist" style="flex: 0.4;">
        ...
        this.#pages = {
            ...
            trajectory: {
                ...
                clear: ()=>{
                    ...
                    this.#isEnd = false;
                    this.hint('读取事件：在getid显示当前年龄发生事件的id及权重\n写入事件：从setid读取事件id并执行(输入不合法id将发生错误)\n点击setid跳转到事件模板');
                },
                born: contents => {
